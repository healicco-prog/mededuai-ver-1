...
const STEPS = [
    ...
    { key: 'mentees', label: 'Mentee Management', icon: UserPlus, color: 'from-violet-500 to-emerald-600', bgLight: 'bg-violet-50', textColor: 'text-violet-700', borderColor: 'border-violet-200', ringColor: 'ring-violet-400', badgeBg: 'bg-violet-100', iconBg: 'bg-violet-500' },
