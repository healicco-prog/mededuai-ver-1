...
import { FilePenLine as FileEdit, Loader2, Sparkles, RefreshCcw, Download, Copy, CheckCircle, BookOpen, Save, Share2, FileDown, X, Plus, Search, History, Trash2 } from 'lucide-react';
                ...
                <div className="bg-gradient-to-r from-emerald-900 via-teal-900 to-cyan-900 rounded-3xl p-6 shadow-xl overflow-hidden relative">
                    ...
                    <div className="relative flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-emerald-300/80 text-sm font-medium">AI-powered teaching notes for your curriculum</p>
                        </div>
                    </div>
                </div>
            </div>
